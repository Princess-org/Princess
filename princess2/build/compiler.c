...
typedef enum compiler_DebugValueKind {compiler_DebugValueKind_NULL = 0, compiler_DebugValueKind_BOOL = 1, compiler_DebugValueKind_INT = 2, compiler_DebugValueKind_STRING = 3, compiler_DebugValueKind_METADATA = 4, compiler_DebugValueKind_CONST = 5, compiler_DebugValueKind_DIEXP = 6} compiler_DebugValueKind;
...
DLL_EXPORT compiler_Value compiler_charp(string str, compiler_State *state) {
 ...
 void _87f75ce3_push_scope(parser_Node *node, compiler_State *state) {
    if ((!toolchain_debug_sym)) {
        return ;
    }  ;
 ...
 void _87f75ce3_pop_scope(compiler_State *state) {
    if (toolchain_debug_sym) {
...
DLL_EXPORT void compiler_walk(parser_Node *node, compiler_State *state);
 ...
 compiler_Value _87f75ce3_walk_String(parser_Node *node, compiler_State *state) {
    ...
    compiler_Insn *gep = compiler_make_insn_dbg(compiler_InsnKind_GETELEMENTPTR, loc);
    ...
    compiler_Insn *insert = compiler_make_insn_dbg(compiler_InsnKind_INSERTVALUE, loc);
 ...
 compiler_Value _87f75ce3_convert_to(parser_Node *node, compiler_Value value, typechecking_Type *tpe, compiler_State *state) {
    ...
    if ((((*tpe).kind) == typechecking_TypeKind_ARRAY)) {
        if (((((*(value.tpe)).kind) == typechecking_TypeKind_STATIC_ARRAY) && (((*(value.tpe)).length) == 0))) {
            ...
            if ((!((*tpe).tpe))) {
                ...
                compiler_Insn *bitcast = compiler_make_insn_dbg(compiler_InsnKind_BITCAST, loc);
            ...
            compiler_Insn *extract1 = compiler_make_insn_dbg(compiler_InsnKind_EXTRACTVALUE, loc);
            ...
            compiler_Insn *extract2 = compiler_make_insn_dbg(compiler_InsnKind_EXTRACTVALUE, loc);
            ...
            compiler_Insn *insert1 = compiler_make_insn_dbg(compiler_InsnKind_INSERTVALUE, loc);
            ...
            compiler_Insn *insert2 = compiler_make_insn_dbg(compiler_InsnKind_INSERTVALUE, loc);
        ...
        if (typechecking_is_float((value.tpe))) {
            ...
            compiler_Insn *insn = compiler_make_insn_dbg(compiler_InsnKind_FCMP, loc);
            ...
            compiler_Value ret = compiler_make_local_value(builtins_bool_, NULL, state);
            compiler_Insn *insn = compiler_make_insn_dbg(compiler_InsnKind_ICMP, loc);
    ...
    compiler_Value ret = compiler_make_local_value(tpe, NULL, state);
    compiler_Insn *insn = compiler_make_insn_dbg(kind, loc);
 ...
 compiler_Value _87f75ce3_walk_StructLitUnion(parser_Node *node, compiler_State *state) {
    ...
    compiler_Insn *alloca = compiler_make_insn_dbg(compiler_InsnKind_ALLOCA, loc);
    ...
    compiler_push_insn(bitcast, state);
    compiler_Insn *store = compiler_make_insn_dbg(compiler_InsnKind_STORE, loc);
    ...
    compiler_Insn *load = compiler_make_insn_dbg(compiler_InsnKind_LOAD, loc);
 ...
 compiler_Value _87f75ce3_walk_ArithmeticOp(parser_Node *node, compiler_InsnKind insn_kind, typechecking_Type *tpe, compiler_State *state) {
    ...
    compiler_Insn *insn = compiler_make_insn_dbg(insn_kind, loc);
 ...
 compiler_Value _87f75ce3_walk_USub(parser_Node *node, compiler_State *state) {
    ...
    if ((((*tpe).kind) == typechecking_TypeKind_FLOAT)) {
        compiler_Insn *fneg = compiler_make_insn_dbg(compiler_InsnKind_FNEG, loc);
        (((*fneg).value).fneg) = ((compiler_InsnFneg){ .ret = ret, .value = expr });
        compiler_push_insn(fneg, state);
    }  else {
        compiler_Insn *sub = compiler_make_insn_dbg(compiler_InsnKind_SUB, loc);
 ...
 compiler_Value _87f75ce3_walk_Not(parser_Node *node, compiler_State *state) {
    ...
    compiler_Value ret = compiler_make_local_value(builtins_bool_, NULL, state);
    compiler_Insn *xor = compiler_make_insn_dbg(compiler_InsnKind_XOR, loc);
 ...
 compiler_Value _87f75ce3_walk_And(parser_Node *node, compiler_State *state) {
    ...
    compiler_push_insn(alloca, state);
    compiler_Insn *br = compiler_make_insn_dbg(compiler_InsnKind_BR, loc);
    (((*br).value).br) = ((compiler_InsnBr){ .cond = left });
    compiler_Insn *to_end = compiler_make_insn_dbg(compiler_InsnKind_BR_UNC, loc);
    compiler_push_insn(br, state);
    compiler_Label if_false = compiler_make_label(state);
    compiler_push_label(if_false, state);
    compiler_Insn *store1 = compiler_make_insn_dbg(compiler_InsnKind_STORE, loc);
    ...
    compiler_Insn *store2 = compiler_make_insn_dbg(compiler_InsnKind_STORE, loc);
 ...
 compiler_Value _87f75ce3_walk_Identifier(parser_Node *node, compiler_State *state) {
    ...
    compiler_Value *locv = malloc((sizeof(compiler_Value)));
    (*locv) = ((compiler_Value){ .kind = kind, .name = name, .tpe = typechecking_pointer(tpe) });
    if ((!typechecking_is_function(tpe))) {
        compiler_Value value = compiler_make_local_value(tpe, locv, state);
        compiler_Insn *insn = compiler_make_insn_dbg(compiler_InsnKind_LOAD, loc);
        (((*insn).value).load) = ((compiler_InsnLoad){ .value = value, .loc = (*locv) });
        compiler_push_insn(insn, state);
        return value;
    }  else {
        ((*locv).name) = typechecking_mangle_function_name(((*tpe).type_name), ((*tpe).parameter_t));
        compiler_Value value = ((compiler_Value){ .kind = compiler_ValueKind_LOCAL, .name = name, .tpe = tpe, .addr = locv });
        return value;
    };
};
 ...
 compiler_Value _87f75ce3_walk_ArraySubscript(parser_Node *node, compiler_State *state) {
    ...
    if ((((*array_tpe).kind) == typechecking_TypeKind_ARRAY)) {
        ...
        compiler_Insn *gep1 = compiler_make_insn_dbg(compiler_InsnKind_GETELEMENTPTR, loc);
        ...
        compiler_Insn *load1 = compiler_make_insn_dbg(compiler_InsnKind_LOAD, loc);
        ...
        compiler_Insn *gep2 = compiler_make_insn_dbg(compiler_InsnKind_GETELEMENTPTR, loc);
        (((*gep2).value).gep) = ((compiler_InsnGetElementPtr){ .ret = gep_ret2, .tpe = ((*node).tpe), .value = load1_value, .index = index2 });
        compiler_Value *addr = malloc((sizeof(compiler_Value)));
        (*addr) = gep_ret2;
        compiler_Value ret = compiler_make_local_value(((*node).tpe), addr, state);
        compiler_Insn *load2 = compiler_make_insn_dbg(compiler_InsnKind_LOAD, loc);
 ...
 compiler_Value _87f75ce3_compare(parser_Node *node, compiler_Value left, compiler_Value right, compiler_State *state) {
    ...
    if ((typechecking_is_arithmetic((left.tpe)) && typechecking_is_arithmetic((right.tpe)))) {
        ...
        if (typechecking_equals((left.tpe), builtins_string_)) {
            ...
            compiler_Insn *call = compiler_make_insn_dbg(compiler_InsnKind_CALL, loc);
            ...
            compiler_Insn *cmp = compiler_make_insn_dbg(compiler_InsnKind_ICMP, loc);
 ...
 compiler_Value _87f75ce3_walk_ComparisionOp(parser_Node *node, compiler_State *state) {
    ...
    if (((((*left).kind) >= parser_NodeKind_EQ) && (((*left).kind) <= parser_NodeKind_LEQ))) {
        ...
        compiler_Value ret = compiler_make_local_value(builtins_bool_, NULL, state);
        compiler_Insn *insn_and = compiler_make_insn_dbg(compiler_InsnKind_AND, loc);
 ...
 compiler_Value _87f75ce3_walk_PointerOp(parser_Node *node, compiler_InsnKind kind, compiler_State *state) {
    ...
    compiler_Insn *arith = compiler_make_insn_dbg(kind, loc);
    ...
    compiler_Insn *inttoptr = compiler_make_insn_dbg(compiler_InsnKind_INTTOPTR, loc);
...
DLL_EXPORT compiler_Value compiler_walk_expression(parser_Node *node, compiler_State *state) {
 ...
 void _87f75ce3_walk_If(parser_Node *node, compiler_State *state) {
    ...
    compiler_Insn *entry = compiler_make_insn_dbg(compiler_InsnKind_BR, loc);
    (((*entry).value).br) = ((compiler_InsnBr){ .cond = cond, .if_true = entry_label });
    compiler_Insn *exit = compiler_make_insn_dbg(compiler_InsnKind_BR_UNC, loc);
    compiler_push_insn(entry, state);
    compiler_push_label(entry_label, state);
    _87f75ce3_push_scope(node, state);
    ...
    for (int i = 0;(i < vector_length(((((*node).value).if_).else_if)));(i += 1)) {
        ...
        entry = compiler_make_insn_dbg(compiler_InsnKind_BR, loc);
        (((*entry).value).br) = ((compiler_InsnBr){ .cond = cond });
        compiler_push_insn(entry, state);
        compiler_Label entry_label = compiler_make_label(state);
        ((((*entry).value).br).if_true) = entry_label;
        compiler_push_label(entry_label, state);
        _87f75ce3_push_scope(else_if, state);
    ...
    if (else_) {
        ...
        compiler_push_label(entry_label, state);
        _87f75ce3_push_scope(else_, state);
...
int _87f75ce3_max_cases;
 void _87f75ce3_walk_Switch(parser_Node *node, compiler_State *state) {
    ...
    compiler_Insn *swtch = compiler_make_insn_dbg(compiler_InsnKind_SWITCH, loc);
    (((*swtch).value).switch_) = ((compiler_InsnSwitch){ .value = swexpr, .switch_values = switch_values });
    compiler_push_insn(swtch, state);
    compiler_Insn *end = compiler_make_insn_dbg(compiler_InsnKind_BR_UNC, loc);
    ...
    for (int i = 0;(i < vector_length(((((*node).value).switch_).body)));(i += 1)) {
        ...
        if ((len == 0)) {
            ...
            if ((!out_of_bounds)) {
                ...
                ;
                _87f75ce3_push_scope(cse, state);
    ...
    ;
    if (otherwise) {
        _87f75ce3_push_scope(otherwise, state);
 ...
 void _87f75ce3_walk_Return(parser_Node *node, compiler_State *state) {
    ...
    compiler_Insn *ret = compiler_make_insn_dbg(compiler_InsnKind_RET, loc);
 ...
 void _87f75ce3_walk_For(parser_Node *node, compiler_State *state) {
    ...
    if ((((*iddecl).kind) == parser_NodeKind_FOR_ID_DECL)) {
        ...
        locv = ((compiler_Value){ .kind = compiler_ValueKind_LOCAL, .name = ((*value).assembly_name), .tpe = typechecking_pointer(tpe) });
    }  else {
    ...
    compiler_Insn *store = compiler_make_insn_dbg(compiler_InsnKind_STORE, loc);
    (((*store).value).store) = ((compiler_InsnStore){ .loc = locv, .value = startv });
    compiler_push_insn(store, state);
    _87f75ce3_push_loop_state(state);
    compiler_Insn *continue_insn = _87f75ce3_get_continue_insn(state);
    compiler_Insn *break_insn = _87f75ce3_get_break_insn(state);
    compiler_Insn *start_insn = compiler_make_insn_dbg(compiler_InsnKind_BR_UNC, loc);
    compiler_push_insn(start_insn, state);
    compiler_Label start_label = compiler_make_label(state);
    compiler_push_label(start_label, state);
    compiler_Value load_ret = compiler_make_local_value(builtins_int_, NULL, state);
    compiler_Insn *load = compiler_make_insn_dbg(compiler_InsnKind_LOAD, loc);
    (((*load).value).load) = ((compiler_InsnLoad){ .value = load_ret, .loc = locv });
    compiler_push_insn(load, state);
    ...
    compiler_Insn *add = compiler_make_insn_dbg(compiler_InsnKind_ADD, loc);
    ...
    compiler_Insn *store2 = compiler_make_insn_dbg(compiler_InsnKind_STORE, loc);
    (((*store2).value).store) = ((compiler_InsnStore){ .loc = locv, .value = add_ret });
    compiler_push_insn(store2, state);
    compiler_push_insn(start_insn, state);
    compiler_Label end_label = compiler_make_label(state);
    compiler_push_label(end_label, state);
 ...
 void _87f75ce3_walk_VarDecl(parser_Node *node, compiler_State *state) {
    ...
    for (int i = 0;(i < vector_length(left));(i += 1)) {
        ...
        if ((((*n).kind) == parser_NodeKind_ID_DECL)) {
            ...
            compiler_Insn *insn = compiler_make_insn_dbg(compiler_InsnKind_ALLOCA, loc);
...
DLL_EXPORT void compiler_walk(parser_Node *node, compiler_State *state) {
 ...
 compiler_Value * _87f75ce3_di_forward_declare(typechecking_Type *tpe, string name, compiler_State *state) {
 ...
 compiler_Value * _87f75ce3_di_type(typechecking_Type *tpe, compiler_State *state) {
    ...
    switch (((int)((*tpe).kind))) {
        ...
        (*ditpe) = (*_87f75ce3_di_forward_declare(tpe, name, state));
        break;
        default:
        fprintf(stderr, (((Array){5, "%d%s"}).value), ((*tpe).kind), (((Array){2, "\x0a"""}).value));
        assert(false);
