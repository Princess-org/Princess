...
%"linux::siginfo_t" = type {i32, i32, i32, i32, %"<anonymous>.0"}
%"<anonymous>.0" = type {[112 x i8]}
%"<anonymous>.1" = type {i32, i32}
%"<anonymous>.2" = type {i32, i32, %"linux::u_sigval"}
%"<anonymous>.3" = type {i32, i32, %"linux::u_sigval"}
%"<anonymous>.4" = type {i32, i32, i32, i64, i64}
%"<anonymous>.7" = type {i8*, i16, %"<anonymous>.5"}
%"<anonymous>.5" = type {[16 x i8]}
%"<anonymous>.6" = type {i8*, i8*}
%"<anonymous>.8" = type {i64, i32}
%"<anonymous>.9" = type {i8*, i32, i32}
%"linux::sigevent_t" = type {%"linux::u_sigval", i32, i32, %"<anonymous>.0"}
...
%"linux::s___pthread_cond_s" = type {%"<anonymous>.0", %"<anonymous>.2", [2 x i32], [2 x i32], i32, i32, [2 x i32]}
...
%"linux::s_sigaction" = type {%"<anonymous>.0", %"linux::__sigset_t", i32, void ()*}
...
%"linux::s_sigcontext" = type {i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i16, i16, i16, i16, i64, i64, i64, i64, %"<anonymous>.0", [8 x i64]}
...
define void @"linux::__main__::([[char]])"({i64, {i64, i8*}*} %args.value) {
start:
	...
	%1545 = getelementptr [10 x i8], [10 x i8]* @"linux::str.262", i64 0, i64 0
	%1546 = insertvalue {i64, i8*} {i64 10, i8* undef}, i8* %1545, 1
	store {i64, i8*} %1546, {i64, i8*}* %tmp.258
	%1547 = load {i64, i8*}, {i64, i8*}* %tmp.258
	%1548 = getelementptr [5 x {i64, i8*}], [5 x {i64, i8*}]* @"linux::__VAR_NAMES", i32 0, i32 0
	store {i64, i8*} %1547, {i64, i8*}* %1548
	%1549 = bitcast i8*** @"__environ" to i8*
	%1550 = getelementptr [5 x i8*], [5 x i8*]* @"linux::__VARS", i32 0, i32 0
	store i8* %1549, i8** %1550
	%1551 = getelementptr [7 x i8], [7 x i8]* @"linux::str.263", i64 0, i64 0
	%1552 = insertvalue {i64, i8*} {i64 7, i8* undef}, i8* %1551, 1
	store {i64, i8*} %1552, {i64, i8*}* %tmp.259
	%1553 = load {i64, i8*}, {i64, i8*}* %tmp.259
	%1554 = getelementptr [5 x {i64, i8*}], [5 x {i64, i8*}]* @"linux::__VAR_NAMES", i32 0, i32 1
	store {i64, i8*} %1553, {i64, i8*}* %1554
	%1555 = bitcast i8** @"optarg" to i8*
	%1556 = getelementptr [5 x i8*], [5 x i8*]* @"linux::__VARS", i32 0, i32 1
	store i8* %1555, i8** %1556
	%1557 = getelementptr [7 x i8], [7 x i8]* @"linux::str.264", i64 0, i64 0
	%1558 = insertvalue {i64, i8*} {i64 7, i8* undef}, i8* %1557, 1
	store {i64, i8*} %1558, {i64, i8*}* %tmp.260
	%1559 = load {i64, i8*}, {i64, i8*}* %tmp.260
	%1560 = getelementptr [5 x {i64, i8*}], [5 x {i64, i8*}]* @"linux::__VAR_NAMES", i32 0, i32 2
	store {i64, i8*} %1559, {i64, i8*}* %1560
	%1561 = bitcast i32* @"optind" to i8*
	%1562 = getelementptr [5 x i8*], [5 x i8*]* @"linux::__VARS", i32 0, i32 2
	...
	%1566 = getelementptr [5 x {i64, i8*}], [5 x {i64, i8*}]* @"linux::__VAR_NAMES", i32 0, i32 3
	store {i64, i8*} %1565, {i64, i8*}* %1566
	%1567 = bitcast i32* @"opterr" to i8*
	%1568 = getelementptr [5 x i8*], [5 x i8*]* @"linux::__VARS", i32 0, i32 3
	...
	%1572 = getelementptr [5 x {i64, i8*}], [5 x {i64, i8*}]* @"linux::__VAR_NAMES", i32 0, i32 4
	store {i64, i8*} %1571, {i64, i8*}* %1572
	%1573 = bitcast i32* @"optopt" to i8*
	%1574 = getelementptr [5 x i8*], [5 x i8*]* @"linux::__VARS", i32 0, i32 4
...
0:
	...
	ret {i64, i8*} %2
3:
	%4 = getelementptr [6 x i8], [6 x i8]* @"linux::str.1", i32 0, i32 0
	%5 = insertvalue {i64, i8*} {i64 6, i8* undef}, i8* %4, 1
	ret {i64, i8*} %5
6:
	%7 = getelementptr [7 x i8], [7 x i8]* @"linux::str.2", i32 0, i32 0
...
define void @"linux::__finalizer__::()"() {
start:
	ret void
}
...
@"linux::__VARS" = global [5 x i8*] zeroinitializer
@"linux::__VAR_NAMES" = global [5 x {i64, i8*}] zeroinitializer
@"linux::str.0" = private global [6 x i8] c"P_ALL\00"
@"linux::str.1" = private global [6 x i8] c"P_PID\00"
@"linux::str.2" = private global [7 x i8] c"P_PGID\00"
...
@"linux::str.262" = private global [10 x i8] c"__environ\00"
@"linux::str.263" = private global [7 x i8] c"optarg\00"
@"linux::str.264" = private global [7 x i8] c"optind\00"
@"linux::str.265" = private global [7 x i8] c"opterr\00"
@"linux::str.266" = private global [7 x i8] c"optopt\00"
